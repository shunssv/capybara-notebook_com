										...
										<?php foreach ($header_images as $header) : ?>
											<div class="header-slides-slide">
												<a href="<?php echo $header_img_link; ?>">
													<img src="<?php echo esc_url($header['url']); ?>" width="<?php echo add_theme_support( 'custom-header' ); ?>" height="<?php echo add_theme_support( 'custom-header' ); ?>" data-st-lazy-load="false" >
												</a>
											</div>
										<?php endforeach; ?>
									</div>
							...
							<a href="<?php echo $header_img_link; ?>">
								<div id="st-header">
									<?php if( get_option( 'st_mobile_header' ) && st_is_mobile() ) : ?>
											<img src="<?php echo esc_url( get_option( 'st_mobile_header' ) ); ?>" width="100%" height="auto" >
									<?php else: ?>
											<img src="<?php header_image(); ?>" width="<?php echo add_theme_support( 'custom-header' ); ?>" height="<?php echo add_theme_support( 'custom-header' ); ?>" data-st-lazy-load="false" >
									<?php endif; ?>
								</div>
							</a>
						</div>
