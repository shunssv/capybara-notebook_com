...
<?php if ( isset($GLOBALS['myaf32']) && $GLOBALS['myaf32'] === 'yes' ): // ボタンを丸いデザインにする ?>
	.rankstlink-r p a,
	.rankstlink-l p a,
	.rankstlink-r2 p a,
	.rankstlink-a p a,
...
#side .rankid2 .rankh4:not([class^="is-style-st-heading-custom-"]):not([class*=" is-style-st-heading-custom-"]):not(.st-css-no) {
	<?php if ( trim( $GLOBALS["myaf20"] ) !== '' ) { ?>
		background-image: url(<?php echo $GLOBALS["myaf20"];?>)!important;
	<?php }else{ ?>
		<?php if ( trim( $GLOBALS["myaf18"] ) !== '' ) { ?>
			background-image: url(<?php echo $GLOBALS["myaf18"];?>);
		<?php }else{ ?>
...
#side .rankid3 .rankh4:not([class^="is-style-st-heading-custom-"]):not([class*=" is-style-st-heading-custom-"]):not(.st-css-no) {
	<?php if ( trim( $GLOBALS["myaf21"] ) !== '' ) { ?>
		background-image: url(<?php echo $GLOBALS["myaf21"];?>)!important;
	<?php }else{ ?>
		<?php if ( trim( $GLOBALS["myaf18"] ) !== '' ) { ?>
			background-image: url(<?php echo $GLOBALS["myaf18"];?>);
		<?php }else{ ?>
