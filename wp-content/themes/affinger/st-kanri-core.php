	...
	?>
		...
		<p>各記事一覧で表示するサムネイルデザインです。※子テーマや設定によっては反映されないデザインもあります</p>
               ...
               <p>
				   ...
				   サムネイルの形状・サイズ・角丸設定からブログカードを除外（※一部、カードURL含む）</p>
		...
		<p>アイキャッチが無い時のサムネイル画像URL：<input type="text" name="st-data97" value="<?php echo esc_attr( ( $GLOBALS["stdata97"] ) ); ?>" style="width:100%" style="ime-mode:disabled;" placeholder="http://example.com/hoge.png">&nbsp;※150px以上推奨</p>
			...
			<h5 id="サムネイル画像縦横比" class="grid-bg"><i class="st-fa st-svg-file-image-o" aria-hidden="true"></i>スライド・カード型 サムネイル画像の縦横比</h5>
	...
	<div id="sonota" class="st-tabs-content">
		...
		<ul class="theme-kanri-menu">
			...
			<li><a href="#テーマのアップデート更新通知"><i class="st-fa st-svg-refresh" aria-hidden="true"></i>テーマのアップデート更新通知</a></li>
               ...
               <p>
                    <input type="checkbox" name="st-data618" value="yes" <?php if ( $GLOBALS["stdata618"] === 'yes' ) {
                         echo 'checked';
                    } ?>>
				   空のPタグに要素（余白）を挿入しない</p>
