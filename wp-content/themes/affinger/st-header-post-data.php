	...
	<?php if ( $show_post_info ): ?>
		<div id="st-header-post-under-box" class="st-header-post-data <?php echo esc_attr( $post_header_bg_class ); ?>"
			...
			<div class="st-content-width st-dark-cover">
				...
				<?php if ( is_single() && ! isset( $GLOBALS['stdata60'] ) || $GLOBALS['stdata60'] !== 'yes' ): ?>
					<?php
				...
				<?php if ( is_single() && isset( $GLOBALS["stdata24"] ) && $GLOBALS["stdata24"] === 'yes' ):
	 ?>
					<span style="display:none;"><?php get_template_part( 'itiran-date-singular' ); ?></span>
				<?php elseif ( ( is_page() || st_is_home_check() ) && isset( $GLOBALS["stdata104"] ) && $GLOBALS["stdata104"] === 'yes' ):
 ?>
					<span style="display:none;"><?php get_template_part( 'itiran-date-singular' ); ?></span>
				<?php else: ?>
