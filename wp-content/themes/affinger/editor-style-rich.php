...
<?php else: ?>
	...
	<?php elseif ( $st_h3_designsetting === 'leftlinedesign' ):    // 左ラインデザインに変更（※要ボーダー色） ?>
		.h3modoki::before,
		.h3modoki::after,
		.post h3:not([class^="is-style-st-heading-custom-"]):not([class*=" is-style-st-heading-custom-"]):not(.st-css-no):not(.st-matome):not(.rankh3):not(#reply-title)::before,
		.post h3:not([class^="is-style-st-heading-custom-"]):not([class*=" is-style-st-heading-custom-"]):not(.st-css-no):not(.st-matome):not(.rankh3):not(#reply-title)::after {
			content: none!important;
			border: none!important;
		}
	...
	<?php elseif ( $st_h3_designsetting === 'centerlinedesign' ):    // センターラインに変更（※要ボーダー色） ?>
		.h3modoki,
		.post h3:not([class^="is-style-st-heading-custom-"]):not([class*=" is-style-st-heading-custom-"]):not(.st-css-no):not(.st-matome):not(.rankh3):not(#reply-title) {
			display: -webkit-box;
			display: -webkit-flex;
			display: -ms-flexbox;
			display: flex;
