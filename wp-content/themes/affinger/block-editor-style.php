...
.editor-styles-wrapper .is-style-st-timeline-list.has-background > li::before,
.editor-styles-wrapper .is-style-st-timeline-list.has-st-border > li::before {
	left: -.75em;
}
...
.version-5-8 .components-popover__content .block-editor-block-preview__container [class^="is-style-st-paragraph-"],
.version-5-8 .components-popover__content .block-editor-block-preview__container [class*=" is-style-st-paragraph-"],
.version-5-8 .interface-interface-skeleton__sidebar .block-editor-block-preview__container [class^="is-style-st-paragraph-"],
.version-5-8 .interface-interface-skeleton__sidebar .block-editor-block-preview__container [class*=" is-style-st-paragraph-"] {
	padding: 100px 20px;
}
...
@media (min-width: 600px) and (max-width: 781px) {
	.editor-styles-wrapper .wp-block-columns:not(.is-st-fixed-columns) > .block-editor-inner-blocks > .block-editor-block-list__layout > [data-type="core/column"] {
		margin-right: 0 !important;
		margin-left: 0 !important;
...
<?php if ( isset($GLOBALS['stdata498']) && $GLOBALS['stdata498'] === 'yes' ) : // 要素にドロップシャドウを追加 ?>
	.editor-styles-wrapper [class^="is-style-st-paragraph-"]:not(.is-style-st-paragraph-button):not(.is-style-st-paragraph-memo):not(.is-style-st-paragraph-dotline):not(.is-style-st-paragraph-kaiwa),
	.editor-styles-wrapper [class*=" is-style-st-paragraph-"]:not(.is-style-st-paragraph-button):not(.is-style-st-paragraph-memo):not(.is-style-st-paragraph-dotline):not(.is-style-st-paragraph-kaiwa),
	.editor-styles-wrapper .is-style-st-paragraph-kaiwa,
